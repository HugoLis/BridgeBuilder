...
let NusaPlus = Python.import("NusaPlus")
...
simulation.add_force(node3, [100,0])
//simulation.add_force(node2, [0,500])
...
NusaPlus.plot_proportional_model(simulation)
NusaPlus.plot_proportional_area_model(simulation)
...
simulation.plot_model()
//NusaPlus.plot_deformed_shape_stress(simulation)
Pyplot.show()
